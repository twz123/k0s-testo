...
func (n *Network) Validate() []error {
	...
	if validCIDRs {
		...
		// https://github.com/kubernetes/kubernetes/blob/v1.37.0-alpha.0/cmd/kube-apiserver/app/options/validation.go#L52-L58
	...
	if n.DualStack.Enabled {
		...
		if err != nil {
			...
			// https://github.com/kubernetes/kubernetes/blob/v1.37.0-alpha.0/cmd/kube-apiserver/app/options/validation.go#L39
			maxCIDRBits := 20
